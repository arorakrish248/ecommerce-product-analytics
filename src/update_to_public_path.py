...
-- 3. BULK IMPORT FROM C:/Users/Public (Full Read Permissions for PostgreSQL)
COPY dim_customers FROM '{public_dir}/dim_customers.csv' WITH (FORMAT csv, HEADER true);
COPY dim_products FROM '{public_dir}/dim_products.csv' WITH (FORMAT csv, HEADER true);
COPY dim_sellers FROM '{public_dir}/dim_sellers.csv' WITH (FORMAT csv, HEADER true);
COPY fact_orders FROM '{public_dir}/fact_orders.csv' WITH (FORMAT csv, HEADER true);
COPY fact_order_items FROM '{public_dir}/fact_order_items.csv' WITH (FORMAT csv, HEADER true);
COPY fact_order_payments FROM '{public_dir}/fact_order_payments.csv' WITH (FORMAT csv, HEADER true);
COPY fact_order_reviews FROM '{public_dir}/fact_order_reviews.csv' WITH (FORMAT csv, HEADER true);
...
print("Updated sql/RUN_IN_PGADMIN.sql to use C:/Users/Public/ path.")

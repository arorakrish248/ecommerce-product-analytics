...
-- Paste this ENTIRE script into pgAdmin Query Tool and click Execute (F5)
-- ==============================================================================
...
-- 3. BULK DATA IMPORT (Direct PostgreSQL COPY Commands)
...
-- 4. VALIDATION QUERY (Verify Table Counts)
...
print("Created sql/RUN_IN_PGADMIN.sql successfully!")

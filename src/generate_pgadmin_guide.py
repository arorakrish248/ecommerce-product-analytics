...
output_dir = 'C:/Users/krish/.gemini/antigravity/scratch/ecommerce-product-analytics/sql/pgadmin_import'
os.makedirs(output_dir, exist_ok=True)

# Generate single combined pgAdmin setup script
pgadmin_master_sql = """-- ==============================================================================
-- PGADMIN / POSTGRESQL MASTER SETUP SCRIPT
-- E-Commerce Product & Business Analytics Project
-- ==============================================================================

-- Step 1: Create Database (Run this query first if you haven't created the database)
-- CREATE DATABASE ecommerce_analytics;

-- Step 2: Create Star/Snowflake Schema Tables & Indexes
...
-- Step 3: Fast CSV Import via pgAdmin / PostgreSQL COPY Command
-- (Make sure the path matches your local files or use pgAdmin 'Import/Export Data' UI)

/*
COPY dim_customers FROM 'C:/Users/krish/.gemini/antigravity/scratch/ecommerce-product-analytics/data/processed/dim_customers.csv' WITH (FORMAT csv, HEADER true);
COPY dim_products FROM 'C:/Users/krish/.gemini/antigravity/scratch/ecommerce-product-analytics/data/processed/dim_products.csv' WITH (FORMAT csv, HEADER true);
COPY dim_sellers FROM 'C:/Users/krish/.gemini/antigravity/scratch/ecommerce-product-analytics/data/processed/dim_sellers.csv' WITH (FORMAT csv, HEADER true);
COPY fact_orders FROM 'C:/Users/krish/.gemini/antigravity/scratch/ecommerce-product-analytics/data/processed/fact_orders.csv' WITH (FORMAT csv, HEADER true);
COPY fact_order_items FROM 'C:/Users/krish/.gemini/antigravity/scratch/ecommerce-product-analytics/data/processed/fact_order_items.csv' WITH (FORMAT csv, HEADER true);
COPY fact_order_payments FROM 'C:/Users/krish/.gemini/antigravity/scratch/ecommerce-product-analytics/data/processed/fact_order_payments.csv' WITH (FORMAT csv, HEADER true);
COPY fact_order_reviews FROM 'C:/Users/krish/.gemini/antigravity/scratch/ecommerce-product-analytics/data/processed/fact_order_reviews.csv' WITH (FORMAT csv, HEADER true);
*/
"""

with open('sql/pgadmin_master_setup.sql', 'w', encoding='utf-8') as f:
    f.write(pgadmin_master_sql)

print("pgadmin_master_setup.sql created successfully in sql/")
